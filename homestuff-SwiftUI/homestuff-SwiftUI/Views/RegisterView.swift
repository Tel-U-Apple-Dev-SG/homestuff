                    ...
                    VStack(spacing: 16) {
                        ...
                        HStack {
                            Image(systemName: "person.fill")
                                ...
                                .padding(.leading, 12)
                            TextField("Nama", text: $nameValue, prompt: Text("Nama").foregroundColor(.gray))
                                .padding(.vertical, 12)
                        ...
                        HStack {
                            Image(systemName: "lock.fill")
                                ...
                                .padding(.leading, 12)
                            if showPassword {
                                TextField("Konfirmasi kata sandi", text: $confirmPasswordValue, prompt: Text("Konfirmasi kata sandi").foregroundColor(.gray))
                                    .padding(.vertical, 12)
                                    .foregroundColor(.black)
                                    .autocapitalization(.none)
                                    .disableAutocorrection(true)
                                ...
                                SecureField("Konfirmasi kata sandi", text: $confirmPasswordValue, prompt: Text("Konfirmasi kata sandi").foregroundColor(.gray))
                                    .padding(.vertical, 12)
                                    .foregroundColor(.black)
                                    .autocapitalization(.none)
                                    .disableAutocorrection(true)
